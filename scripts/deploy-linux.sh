...
echo "PDD Inspector Linux deploy"
echo "Workspace: $ROOT"

require_command node "Install Node.js 20+ with your package manager or https://nodejs.org/"
...
if ! command -v google-chrome >/dev/null 2>&1 && ! command -v google-chrome-stable >/dev/null 2>&1; then
  echo "Warning: Google Chrome was not found. Install Chrome before running inspections." >&2
fi
...
printf "\nDeploy finished.\n"
echo "Start server and worker: ./scripts/start-linux.sh"
