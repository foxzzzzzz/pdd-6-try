...
function seedDefaultRuleReviews(db: AppDb): void {
  const defaults: Array<{ category: RuleReviewCategory; title: string }> = [
    { category: 'review_management', title: '璇勪环绠＄悊瑙勫垯' },
    { category: 'report_hide', title: '涓炬姤/闅愯棌瑙勫垯' },
    { category: 'account_security', title: '鍟嗗鍚庡彴璐﹀彿瀹夊叏瑙勫垯' },
    { category: 'automation_tools', title: '自动化工具/第三方工具限制' },
    { category: 'service_agreements', title: '搴楅摵鎺ㄥ箍/瀹㈡湇/璇勪环鐩稿叧鍗忚' },
  ];
